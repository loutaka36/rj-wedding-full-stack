    ...
    <div className="details">
      ...
      <div className="details-reception">
        ...
        <div className="details-reception_text">
          <div className="details-reception_text__title">Hyatt Regency  Near Naperville</div>
          ...
          <div className="details-reception_text__item">
            <a href="https://www.google.com/maps/place/Hyatt+Regency+Lisle+Near+Naperville/@41.806982,-88.0814548,17z/data=!3m1!4b1!4m8!3m7!1s0x880e5147b5a4f947:0x5399292de51430f1!5m2!4m1!1i2!8m2!3d41.806982!4d-88.0792661" target="_blank">Directions</a>
          </div>
        </div>
      </div>
    </div>
